...
var hierarchy__4705__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__13083 = cljs.core.get_global_hierarchy;
...
var vec__13088 = position;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13088,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13088,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13088,(2),null);
...
zombie.scene.system.physics.body.create_body_STAR_.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"circle","circle",1903212362),(function (p__13091){
var map__13092 = p__13091;
var map__13092__$1 = cljs.core.__destructure_map(map__13092);
var scale = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13092__$1,new cljs.core.Keyword(null,"scale","scale",-230427353));
var radius = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13092__$1,new cljs.core.Keyword(null,"radius","radius",-2073122258));
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13092__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var settings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13092__$1,new cljs.core.Keyword(null,"settings","settings",1556144875));
var vec__13100 = position;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13100,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13100,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13100,(2),null);
return module$node_modules$matter_js$build$matter.Bodies.circle(x,z,(scale * radius),cljs.core.clj__GT_js(settings));
}));
zombie.scene.system.physics.body.create_body_STAR_.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"model-bounding-box","model-bounding-box",-112419983),(function (p__13106){
var map__13107 = p__13106;
var map__13107__$1 = cljs.core.__destructure_map(map__13107);
var scale = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13107__$1,new cljs.core.Keyword(null,"scale","scale",-230427353));
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13107__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var angle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13107__$1,new cljs.core.Keyword(null,"angle","angle",1622094254));
var model_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13107__$1,new cljs.core.Keyword(null,"model-type","model-type",398058196));
var settings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13107__$1,new cljs.core.Keyword(null,"settings","settings",1556144875));
var map__13111 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(zombie.state.databases.model_colliders),model_type);
var map__13111__$1 = cljs.core.__destructure_map(map__13111);
var bb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13111__$1,new cljs.core.Keyword(null,"bounding-box","bounding-box",201336205));
var min = bb.min;
var max = bb.max;
var w = (max.x - min.x);
var h = (max.z - min.z);
var vec__13112 = position;
var px = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13112,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13112,(1),null);
var pz = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13112,(2),null);
