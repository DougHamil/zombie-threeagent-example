...
var statecharts$service$IService$start$dyn_12800 = (function (this$){
...
return statecharts$service$IService$start$dyn_12800(this$);
}
});

var statecharts$service$IService$send$dyn_12801 = (function (this$,event){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return statecharts$service$IService$send$dyn_12801(this$,event);
}
});

var statecharts$service$IService$add_listener$dyn_12802 = (function (this$,id,listener){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return statecharts$service$IService$add_listener$dyn_12802(this$,id,listener);
}
});

var statecharts$service$IService$reload$dyn_12805 = (function (this$,fsm){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return statecharts$service$IService$reload$dyn_12805(this$,fsm);
}
});
...
var map__12795 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([statecharts.service.default_opts(),opts], 0));
var map__12795__$1 = cljs.core.__destructure_map(map__12795);
var clock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12795__$1,new cljs.core.Keyword(null,"clock","clock",-894301127));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(fsm,new cljs.core.Keyword(null,"scheduler","scheduler",-1882870208),statecharts.delayed.make_scheduler((function (p1__12796_SHARP_){
return statecharts.service.send(service,p1__12796_SHARP_);
}),service.clock));
});
