...
})], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("error","message","error/message",-502809098),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"en","en",88457073),"should be a symbol"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("error","fn","error/fn",-1263293860),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"en","en",88457073),(function (p__12399,_){
var map__12400 = p__12399;
var map__12400__$1 = cljs.core.__destructure_map(map__12400);
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12400__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12400__$1,new cljs.core.Keyword(null,"value","value",305978217));
if(typeof value === 'number'){
...
})], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("error","message","error/message",-502809098),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"en","en",88457073),"should be a list"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("error","fn","error/fn",-1263293860),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"en","en",88457073),(function (p__12401,_){
var map__12402 = p__12401;
var map__12402__$1 = cljs.core.__destructure_map(map__12402);
var likely_misspelling_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12402__$1,new cljs.core.Keyword("malli.error","likely-misspelling-of","malli.error/likely-misspelling-of",1504085033));
...
})], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("error","fn","error/fn",-1263293860),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"en","en",88457073),(function (p__12405,_){
var map__12406 = p__12405;
var map__12406__$1 = cljs.core.__destructure_map(map__12406);
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12406__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12406__$1,new cljs.core.Keyword(null,"value","value",305978217));
if(typeof value === 'number'){
...
})], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("error","message","error/message",-502809098),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"en","en",88457073),"should be negative"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("error","fn","error/fn",-1263293860),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"en","en",88457073),(function (p__12407,_){
var map__12408 = p__12407;
var map__12408__$1 = cljs.core.__destructure_map(map__12408);
var likely_misspelling_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12408__$1,new cljs.core.Keyword("malli.error","likely-misspelling-of","malli.error/likely-misspelling-of",1504085033));
...
var fexpr__12409 = malli.core.eval.cljs$core$IFn$_invoke$arity$2(fn,options__$1);
return (fexpr__12409.cljs$core$IFn$_invoke$arity$2 ? fexpr__12409.cljs$core$IFn$_invoke$arity$2(error,options__$1) : fexpr__12409.call(null,error,options__$1));
} else {
return null;
}
})();
...
var G__12414 = cljs.core.vec(x);
var G__12415 = k;
return (malli.error._get.cljs$core$IFn$_invoke$arity$2 ? malli.error._get.cljs$core$IFn$_invoke$arity$2(G__12414,G__12415) : malli.error._get.call(null,G__12414,G__12415));
}
});
...
var G__12416 = cljs.core.vec(x);
var G__12417 = k;
var G__12418 = v;
return (malli.error._put.cljs$core$IFn$_invoke$arity$3 ? malli.error._put.cljs$core$IFn$_invoke$arity$3(G__12416,G__12417,G__12418) : malli.error._put.call(null,G__12416,G__12417,G__12418));

}
}
});
malli.error._assoc_in = (function malli$error$_assoc_in(acc,value,p__12419,error){
while(true){
var vec__12420 = p__12419;
var seq__12421 = cljs.core.seq(vec__12420);
var first__12422 = cljs.core.first(seq__12421);
var seq__12421__$1 = cljs.core.next(seq__12421);
var p = first__12422;
var ps = seq__12421__$1;
...
var value_SINGLEQUOTE_ = ((ps)?(function (){var G__12423 = malli.error._get(acc,p);
var G__12424 = malli.error._get(value,p);
var G__12425 = ps;
var G__12426 = error;
return (malli.error._assoc_in.cljs$core$IFn$_invoke$arity$4 ? malli.error._assoc_in.cljs$core$IFn$_invoke$arity$4(G__12423,G__12424,G__12425,G__12426) : malli.error._assoc_in.call(null,G__12423,G__12424,G__12425,G__12426));
})():error);
...
var G__12488 = acc;
var G__12489 = value;
var G__12490 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli","error","malli/error",-1152359159)], null);
var G__12491 = error;
acc = G__12488;
value = G__12489;
p__12419 = G__12490;
...
malli.error._path = (function malli$error$_path(p__12427,p__12428){
var map__12429 = p__12427;
var map__12429__$1 = cljs.core.__destructure_map(map__12429);
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12429__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var map__12430 = p__12428;
var map__12430__$1 = cljs.core.__destructure_map(map__12430);
var locale = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12430__$1,new cljs.core.Keyword(null,"locale","locale",-2115712697));
var default_locale = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__12430__$1,new cljs.core.Keyword(null,"default-locale","default-locale",-677515761),new cljs.core.Keyword(null,"en","en",88457073));
...
var pred__12433 = (function (p1__12432_SHARP_,p2__12431_SHARP_){
return (p2__12431_SHARP_ <= p1__12432_SHARP_);
});
var expr__12434 = len;
if(pred__12433((4),expr__12434)){
return (0);
} else {
if(pred__12433((5),expr__12434)){
return (1);
} else {
if(pred__12433((6),expr__12434)){
return (2);
} else {
if(pred__12433((11),expr__12434)){
return (3);
} else {
if(pred__12433((20),expr__12434)){
return (4);
} else {
return ((0.2 * len) | (0));
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (row,p__12436){
var vec__12437 = p__12436;
var diagonal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12437,(0),null);
var above = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12437,(1),null);
var other = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12437,(2),null);
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__12441_SHARP_,p2__12440_SHARP_){
return cljs.core.identity(p2__12440_SHARP_);
...
var min_len = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$3(cljs.core.count,(function (p1__12442_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__12442_SHARP_,":")){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$2(p1__12442_SHARP_,(1));
} else {
return p1__12442_SHARP_;
}
...
return cljs.core.not_empty(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(keys,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__12443_SHARP_){
return malli.error._similar_key(p1__12443_SHARP_,key);
}),known_keys)));
}
});
malli.error._most_similar_to = (function malli$error$_most_similar_to(keys,key,known_keys){
return cljs.core.not_empty(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2((function (p1__12444_SHARP_){
return malli.error._levenshtein(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__12444_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(key));
...
(malli.error.with_error_messages.cljs$core$IFn$_invoke$arity$2 = (function (explanation,p__12462){
var map__12463 = p__12462;
var map__12463__$1 = cljs.core.__destructure_map(map__12463);
var options = map__12463__$1;
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__12463__$1,new cljs.core.Keyword(null,"wrap","wrap",851669987),cljs.core.identity);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12458_SHARP_){
var G__12464 = malli.error.with_error_message.cljs$core$IFn$_invoke$arity$2(p1__12458_SHARP_,options);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__12464) : f.call(null,G__12464));
}),errors));
}));
} else {
return null;
...
(malli.error.with_spell_checking.cljs$core$IFn$_invoke$arity$2 = (function (explanation,p__12468){
var map__12469 = p__12468;
var map__12469__$1 = cljs.core.__destructure_map(map__12469);
var keep_likely_misspelled_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12469__$1,new cljs.core.Keyword(null,"keep-likely-misspelled-of","keep-likely-misspelled-of",288878171));
if(cljs.core.truth_(explanation)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(explanation,new cljs.core.Keyword(null,"errors","errors",-908790718),(function (errors){
var $ = errors;
var $__$1 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__12470){
var map__12471 = p__12470;
var map__12471__$1 = cljs.core.__destructure_map(map__12471);
var error = map__12471__$1;
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12471__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12471__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12471__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var vec__12472 = (get_keys.cljs$core$IFn$_invoke$arity$3 ? get_keys.cljs$core$IFn$_invoke$arity$3(schema,path,value) : get_keys.call(null,schema,path,value));
var error_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12472,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12472,(1),null);
var keys = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12472,(2),null);
var similar = malli.error._most_similar_to(keys,key,known_keys);
var likely_misspelling_of = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__12465_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(cljs.core.butlast(path)),p1__12465_SHARP_);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__12476,new cljs.core.Keyword(null,"type","type",1174270348),error_type,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("malli.error","likely-misspelling-of","malli.error/likely-misspelling-of",1504085033),likely_misspelling_of], 0));
} else {
return G__12476;
}
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__12477){
var map__12478 = p__12477;
var map__12478__$1 = cljs.core.__destructure_map(map__12478);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12478__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12478__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var and__4210__auto__ = (function (){var fexpr__12479 = cljs.core.deref(_BANG_likely_misspelling_of);
return (fexpr__12479.cljs$core$IFn$_invoke$arity$1 ? fexpr__12479.cljs$core$IFn$_invoke$arity$1(path) : fexpr__12479.call(null,path));
})();
if(cljs.core.truth_(and__4210__auto__)){
...
(malli.error.humanize.cljs$core$IFn$_invoke$arity$2 = (function (p__12482,p__12483){
var map__12484 = p__12482;
var map__12484__$1 = cljs.core.__destructure_map(map__12484);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12484__$1,new cljs.core.Keyword(null,"value","value",305978217));
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12484__$1,new cljs.core.Keyword(null,"errors","errors",-908790718));
var map__12485 = p__12483;
var map__12485__$1 = cljs.core.__destructure_map(map__12485);
var options = map__12485__$1;
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__12485__$1,new cljs.core.Keyword(null,"wrap","wrap",851669987),new cljs.core.Keyword(null,"message","message",-406056002));
if(cljs.core.truth_(errors)){
if(cljs.core.coll_QMARK_(value)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,error){
return malli.error._assoc_in(acc,value,malli.error.error_path.cljs$core$IFn$_invoke$arity$2(error,options),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__12486 = malli.error.with_error_message.cljs$core$IFn$_invoke$arity$2(error,options);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__12486) : f.call(null,G__12486));
})()], null));
}),null,errors);
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__12487 = malli.error.with_error_message.cljs$core$IFn$_invoke$arity$2(cljs.core.first(errors),options);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__12487) : f.call(null,G__12487));
})()], null);
}
} else {
return null;
