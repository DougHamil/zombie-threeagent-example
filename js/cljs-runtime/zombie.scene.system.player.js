...
zombie.scene.system.player.set_upper_look_at_BANG_ = (function zombie$scene$system$player$set_upper_look_at_BANG_(event_bus,entity_id,p__12910){
...
zombie.scene.system.player.update_movement_BANG_ = (function zombie$scene$system$player$update_movement_BANG_(bus,entity_id,p__12923){
var map__12924 = p__12923;
var map__12924__$1 = cljs.core.__destructure_map(map__12924);
var object = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12924__$1,new cljs.core.Keyword(null,"object","object",1474613949));
var move_input_xy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12924__$1,new cljs.core.Keyword(null,"move-input-xy","move-input-xy",-1370194460));
var move_speed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12924__$1,new cljs.core.Keyword(null,"move-speed","move-speed",1817709482));
var last_look_position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12924__$1,new cljs.core.Keyword(null,"last-look-position","last-look-position",100539945));
...
zombie.scene.system.player.update_weapon_BANG_ = (function zombie$scene$system$player$update_weapon_BANG_(bus,entity_id,player,p__12930){
var map__12931 = p__12930;
var map__12931__$1 = cljs.core.__destructure_map(map__12931);
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12931__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var z = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12931__$1,new cljs.core.Keyword(null,"z","z",-789527183));
var height = 1.5;
...
var map__12936 = zombie.scene.system.player.update_movement_BANG_(bus,entity_id,player);
var map__12936__$1 = cljs.core.__destructure_map(map__12936);
var look_position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12936__$1,new cljs.core.Keyword(null,"look-position","look-position",942946522));
var moving_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12936__$1,new cljs.core.Keyword(null,"moving?","moving?",1843710132));
...
zombie.util.messaging.on(bus,entity_id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("input","action","input/action",-1449044702),new cljs.core.Keyword(null,"aim","aim",-1211687229)], null),(function (p1__12951_SHARP_){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(local_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,new cljs.core.Keyword(null,"aiming?","aiming?",2088975299)], null),p1__12951_SHARP_);

zombie.util.messaging.send(bus,entity_id,new cljs.core.Keyword("player","aiming?","player/aiming?",-1312675420),p1__12951_SHARP_);

return statecharts.core.send.cljs$core$IFn$_invoke$arity$2(anim_fsm,(cljs.core.truth_(p1__12951_SHARP_)?new cljs.core.Keyword(null,"start-aiming","start-aiming",-242869861):new cljs.core.Keyword(null,"stop-aiming","stop-aiming",-1704483240)));
}));

zombie.util.messaging.on(bus,entity_id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("input","action","input/action",-1449044702),new cljs.core.Keyword(null,"fire","fire",-144730624)], null),(function (p1__12952_SHARP_){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(local_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,new cljs.core.Keyword(null,"firing?","firing?",-1865348313)], null),p1__12952_SHARP_);

return zombie.util.messaging.send(bus,entity_id,new cljs.core.Keyword("weapon","fire","weapon/fire",-961423332),p1__12952_SHARP_);
} else {
return null;
}
}));

return zombie.util.messaging.on(bus,entity_id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("input","axis-update","input/axis-update",-159028349),new cljs.core.Keyword(null,"move","move",-2110884309)], null),(function (p1__12953_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(local_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,new cljs.core.Keyword(null,"move-input-xy","move-input-xy",-1370194460)], null),p1__12953_SHARP_);
}));
});
...
(zombie.scene.system.player.PlayerSystem.prototype.threeagent$system$ISystem$on_entity_added$arity$5 = (function (_,___$1,id,obj,p__12972){
var self__ = this;
var map__12973 = p__12972;
var map__12973__$1 = cljs.core.__destructure_map(map__12973);
var move_speed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12973__$1,new cljs.core.Keyword(null,"move-speed","move-speed",1817709482));
var ___$2 = this;
...
var anim_fsm = (function (){var G__12982 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(zombie.scene.system.player.animation_fsm,new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"object","object",1474613949),obj,new cljs.core.Keyword(null,"bus","bus",-1090873603),self__.bus,new cljs.core.Keyword(null,"state","state",-1988618099),c,new cljs.core.Keyword(null,"entity-id","entity-id",1485898093),id], null));
return (statecharts.core.service.cljs$core$IFn$_invoke$arity$1 ? statecharts.core.service.cljs$core$IFn$_invoke$arity$1(G__12982) : statecharts.core.service.call(null,G__12982));
})();
...
var G__13022 = seq__12987;
var G__13023 = chunk__12988;
var G__13024 = count__12989;
var G__13025 = (i__12990 + (1));
seq__12987 = G__13022;
chunk__12988 = G__13023;
count__12989 = G__13024;
i__12990 = G__13025;
continue;
} else {
...
var G__13026 = cljs.core.chunk_rest(seq__12987__$1);
var G__13027 = c__4638__auto__;
var G__13028 = cljs.core.count(c__4638__auto__);
var G__13029 = (0);
seq__12987 = G__13026;
chunk__12988 = G__13027;
count__12989 = G__13028;
i__12990 = G__13029;
continue;
} else {
...
var G__13030 = cljs.core.next(seq__12987__$1);
var G__13031 = null;
var G__13032 = (0);
var G__13033 = (0);
seq__12987 = G__13030;
chunk__12988 = G__13031;
count__12989 = G__13032;
i__12990 = G__13033;
continue;
}
} else {
