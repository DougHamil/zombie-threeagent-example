...
var statecharts$delayed$IScheduler$schedule$dyn_12561 = (function (this$,event,delay){
...
return statecharts$delayed$IScheduler$schedule$dyn_12561(this$,event,delay);
}
});

var statecharts$delayed$IScheduler$unschedule$dyn_12562 = (function (this$,event){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return statecharts$delayed$IScheduler$unschedule$dyn_12562(this$,event);
}
});
...
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"entry","entry",505168823),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"action","action",-811238024),new cljs.core.Keyword("fsm","schedule-event","fsm/schedule-event",1735252958),new cljs.core.Keyword(null,"event-delay","event-delay",-262476060),delay,new cljs.core.Keyword(null,"event","event",301435442),event], null),new cljs.core.Keyword(null,"exit","exit",351849638),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),new cljs.core.Keyword("fsm","unschedule-event","fsm/unschedule-event",-1330804273),new cljs.core.Keyword(null,"event","event",301435442),event], null),new cljs.core.Keyword(null,"on","on",173873944),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [event,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__12548_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__12548_SHARP_,new cljs.core.Keyword(null,"delay","delay",-574225219));
}),txs)], null)], null);
});
statecharts.delayed.derived_delay_info = (function statecharts$delayed$derived_delay_info(delayed_transitions){
var seq__12549_12563 = cljs.core.seq(delayed_transitions);
var chunk__12550_12564 = null;
var count__12551_12565 = (0);
var i__12552_12566 = (0);
while(true){
if((i__12552_12566 < count__12551_12565)){
var dt_12567 = chunk__12550_12564.cljs$core$IIndexed$_nth$arity$2(null,i__12552_12566);
if(cljs.core.contains_QMARK_(dt_12567,new cljs.core.Keyword(null,"delay","delay",-574225219))){
} else {
throw (new Error(["Assert failed: ",["no :delay key found in",cljs.core.str.cljs$core$IFn$_invoke$arity$1(dt_12567)].join(''),"\n","(contains? dt :delay)"].join('')));
}


var G__12568 = seq__12549_12563;
var G__12569 = chunk__12550_12564;
var G__12570 = count__12551_12565;
var G__12571 = (i__12552_12566 + (1));
seq__12549_12563 = G__12568;
chunk__12550_12564 = G__12569;
count__12551_12565 = G__12570;
i__12552_12566 = G__12571;
continue;
} else {
var temp__5753__auto___12572 = cljs.core.seq(seq__12549_12563);
if(temp__5753__auto___12572){
var seq__12549_12573__$1 = temp__5753__auto___12572;
if(cljs.core.chunked_seq_QMARK_(seq__12549_12573__$1)){
var c__4638__auto___12574 = cljs.core.chunk_first(seq__12549_12573__$1);
var G__12575 = cljs.core.chunk_rest(seq__12549_12573__$1);
var G__12576 = c__4638__auto___12574;
var G__12577 = cljs.core.count(c__4638__auto___12574);
var G__12578 = (0);
seq__12549_12563 = G__12575;
chunk__12550_12564 = G__12576;
count__12551_12565 = G__12577;
i__12552_12566 = G__12578;
continue;
} else {
var dt_12579 = cljs.core.first(seq__12549_12573__$1);
if(cljs.core.contains_QMARK_(dt_12579,new cljs.core.Keyword(null,"delay","delay",-574225219))){
} else {
throw (new Error(["Assert failed: ",["no :delay key found in",cljs.core.str.cljs$core$IFn$_invoke$arity$1(dt_12579)].join(''),"\n","(contains? dt :delay)"].join('')));
}


var G__12580 = cljs.core.next(seq__12549_12573__$1);
var G__12581 = null;
var G__12582 = (0);
var G__12583 = (0);
seq__12549_12563 = G__12580;
chunk__12550_12564 = G__12581;
count__12551_12565 = G__12582;
i__12552_12566 = G__12583;
continue;
}
} else {
}
...
}),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"entry","entry",505168823),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"exit","exit",351849638),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"on","on",173873944),cljs.core.PersistentVector.EMPTY], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__12553){
var vec__12554 = p__12553;
var delay = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(0),null);
var txs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12554,(1),null);
...
var map__12557 = statecharts.delayed.derived_delay_info(after);
var map__12557__$1 = cljs.core.__destructure_map(map__12557);
var entry = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12557__$1,new cljs.core.Keyword(null,"entry","entry",505168823));
var exit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12557__$1,new cljs.core.Keyword(null,"exit","exit",351849638));
var on = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12557__$1,new cljs.core.Keyword(null,"on","on",173873944));
...
var G__12560 = node;
var G__12560__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"on","on",173873944).cljs$core$IFn$_invoke$arity$1(node))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__12560,new cljs.core.Keyword(null,"on","on",173873944),replace_path):G__12560);
var G__12560__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"entry","entry",505168823).cljs$core$IFn$_invoke$arity$1(node))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__12560__$1,new cljs.core.Keyword(null,"entry","entry",505168823),replace_path):G__12560__$1);
var G__12560__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"exit","exit",351849638).cljs$core$IFn$_invoke$arity$1(node))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__12560__$2,new cljs.core.Keyword(null,"exit","exit",351849638),replace_path):G__12560__$2);
if(cljs.core.truth_(new cljs.core.Keyword(null,"states","states",1389013542).cljs$core$IFn$_invoke$arity$1(node))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__12560__$3,new cljs.core.Keyword(null,"states","states",1389013542),(function (states){
